...
const clientKey = "test_ck_LkKEypNArWL17lZDP7BZ8lmeaxYG"; // 여기를 내 클라이언트키 로 수정
const customerKey = generateRandomString();

const amount = {
  currency: "KRW",
  value: 250000, // 주 결제 공간. 나중에 값이 변경 될 공간이다.
};
    ...
    switch (selectedPaymentMethod) {
      case "CARD":
        await payment.requestPayment({
          ...
          orderName: "포켓몬스터 하트골드", // "토스 티셔츠 외 2건", // 나중에 SpringBoot 로 상품명을 전달받을 공간
          successUrl: window.location.origin + "/payment/success", // 결제 요청이 성공하면 리다이렉트되는 URL
          failUrl: window.location.origin + "/fail", // 결제 요청이 실패하면 리다이렉트되는 URL
          customerEmail: "kjch911229@gmail.com", // "customer123@gmail.com", // 나중에 SpringBoot 로 구매자(고객) 의 이메일 주소를 전달받을 공간
          customerName: "김종찬", // "김토스", // 나중에 SpringBoot 로 회원가입 후 구매자(고객) 의 이름을 전달받을 공간
          customerMobilePhone: "01096877749", // "01012341234",
          card: {
            useEscrow: false,
            flowMode: "DEFAULT",
            useCardPoint: false,
